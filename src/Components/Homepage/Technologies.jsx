...
const Technologies = () => {
  return (
    <div className="technologies">
      ...
      <h5>
        I have experience developing websites using React, ChakraUI and Flask. I
        have also done a project in NextJS and Tailwind as well.
      </h5>
      ...
      <div className="technologies">
        ...
        <h4>
          I have also worked briefly with the following technologies as well:
        </h4>
