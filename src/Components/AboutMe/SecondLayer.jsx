  ...
  return (
    <div className="container second-layer col-lg-8 col-8-md col-6-sm">
      ...
      <div className="location">
        ...
        <p>
          I am a develeoper based in Edmonton, Canada. I've been here my entire
          life and I will get my bachelor degree here as well.
        </p>
      </div>
      ...
      <div className="plans">
        ...
        <p>
          ...
          science field. Cybersecurity and Big Data are fields that interest me
          the most and I dream of working in.
        </p>
      </div>
