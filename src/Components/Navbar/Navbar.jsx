          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="ms-auto">
              <NavLink to="/about" style={{ textDecoration: "none" }}>
                <Nav.Link href="#about" className="navbarLink active">
                  About
                </Nav.Link>
              </NavLink>

              <NavLink to="/blog" style={{ textDecoration: "none" }}>
                <Nav.Link href="#blog" className="navbarLink active">
                  Blog
                </Nav.Link>
              </NavLink>

              <NavLink to="/resume" style={{ textDecoration: "none" }}>
                <Nav.Link href="#resume" className="navbarLink active">
                  Resume
                </Nav.Link>
              </NavLink>

              <NavLink to="/contact" style={{ textDecoration: "none" }}>
                <Nav.Link href="#contact" className="navbarLink active">
                  Contact
                </Nav.Link>
              </NavLink>
            </Nav>
