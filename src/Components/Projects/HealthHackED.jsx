        ...
        <div>
          ...
          <Collapse in={open}>
            <div id="example-collapse-text">
              <h3>
                <i>
                  "Determine your lung health given user's height, ethnicity and
                  spirometer data"
                </i>
              </h3>
              ...
              <h2>
                <b>Sample code and front-page</b>
              </h2>
              ...
              <p>
                HealthHackED is a project developed by me and four other members
                from the computer science and engineering faculties at the
                University of Alberta. The purpose of the website is to inform
                the user if their lung health is normal or abnormal. The website
                takes in user information such as height, age and ethnicity and
                sends that data to the backend. In the backend, our group took a
                dataset and used data analysis to determine what factors
                contribute to healthy or unhealthy lungs. Then, the user data is
                compared with the data analyzed from the dataset to inform the
                user if their lung health is healthy or abnormal.
                <br />I was responsible for building and designing the front-end
                using React and Chakra UI. I also helped setup the flask server
                so that data can be sent between the front-end and the back-end.
              </p>

              <Button
                className="m-3"
                href="https://github.com/RomanCui/HealthHackED"
              >
                Github Repository
              </Button>
              <Button
                className="m-3"
                href="https://devpost.com/software/healthhacked"
              >
                Devpost Competition
              </Button>
            </div>
